...
|1    |Guichetier     | Compte | Créer|Olivier| | | 
|1    |Guichetier     | Compte | Créditer/Débiter|Alexandre| | | 
|1    |Guichetier     | Compte | Effectuer un virement|Leila| | | 
|1    |Guichetier     | Compte | Clôturer|Alexandre| | | 
