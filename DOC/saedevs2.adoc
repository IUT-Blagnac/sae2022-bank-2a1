...
|2    |Guichetier     | CRUD Prélèvement | C|Alexandre D| | | 
|2    |Guichetier     | CRUD Prélèvement | R|Alexandre D| | | 
|2    |Guichetier     | CRUD Prélèvement | U|Alexandre D| | | 
|2    |Guichetier     | CRUD Prélèvement | D|Alexandre D| | | 
