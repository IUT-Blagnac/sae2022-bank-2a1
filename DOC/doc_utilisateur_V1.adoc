...
* Vous pouvez désactiver un client seulement et seulement si tous les comptes du client en question ont un solde de 0
...
* Vous pouvez notamment créer un compte bancaire
