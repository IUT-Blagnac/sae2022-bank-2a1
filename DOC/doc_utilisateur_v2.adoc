...
* En appuyant sur ce bouton, vous pouvez voir la liste des prélèvements du compe que vous avez sélectionné auparavant.

image::images/read_prelev.PNG[]

* Vous pouvez créer des prélèvements seulement si montant est supérieur à 0 et que la date est entre 1 et 28.
