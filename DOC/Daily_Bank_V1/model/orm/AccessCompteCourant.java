...
public class AccessCompteCourant {
	 ...
	 */
	public void insertCompteCourant(CompteCourant cc) throws RowNotFoundOrTooManyRowsException, DataAccessException,
		...
		try {
			...
			if (res == -1) { // Erreur applicative
				throw new ManagementRuleViolation(Table.Operation, Order.INSERT,
						"Erreur de règle de gestion : solde inférieur à 50", null);
			}
		} catch (SQLException e) {
	 ...
	 *
	 * cc.idNumCompte (clé primaire) doit exister seul cc.estCloture est mis à
	 * jour
	 *
	 * @param cc IN cc.idNumCompte (clé primaire) doit exister seul
	 * @throws RowNotFoundOrTooManyRowsException
