...
public class ComptesManagement {
	...
	public CompteCourant modifierCompte(CompteCourant cp) throws RowNotFoundOrTooManyRowsException, DataAccessException, DatabaseConnexionException {
		AccessClient ac = new AccessClient();
		CompteEditorPane cep = new CompteEditorPane(this.primaryStage, this.dbs);
		CompteCourant result = cep.doCompteEditorDialog(ac.getClient(cp.idNumCli) ,cp, EditionMode.MODIFICATION);
		if (result != null) {
			try {
