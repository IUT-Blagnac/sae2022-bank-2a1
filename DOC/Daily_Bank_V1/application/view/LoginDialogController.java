...
public class LoginDialogController implements Initializable {
	...
	/**
	 * Vérifie si les les champs sont remplis et que le compte existe, si oui se connecte
	 */
	@FXML
	private void doOK() {
		...
		if (login.length() == 0 || password.length() == 0) {
			...
			if (e == null) {
				this.afficheErreur("Identifiants incorrects :");
			} else if (e.motPasse.compareTo("/")==0){
				this.afficheErreur("Compte désactivé :");
			} else {
