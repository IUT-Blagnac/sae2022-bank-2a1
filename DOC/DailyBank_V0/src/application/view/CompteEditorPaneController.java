...
public class CompteEditorPaneController implements Initializable {
	...
	private void doAjouter() {
		...
		case CREATION:
			if (this.isSaisieValide()) {
				...
				int debitAutorise;
				debitAutorise = Integer.parseInt(this.txtDecAutorise.getText().trim());
				
				double montantInitial;
				montantInitial = Double.parseDouble(this.txtSolde.getText().trim());
				
				int idNumClient;
				idNumClient = Integer.parseInt(this.txtIdclient.getText().trim());
				
				//AccessCompteCourant.insertCompteCourant(debitAutorise, montantInitial, idNumClient);
	 ...
	 * 
	 * 
	 * Copier/coller de client valide à modifier (peut-être)
	 * @return boolean
	 */
