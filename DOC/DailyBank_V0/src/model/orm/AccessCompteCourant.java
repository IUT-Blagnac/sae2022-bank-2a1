...
public class AccessCompteCourant {
	 ...
	 *
	 * @param debitAutorise IN seul de débit maximum accepté
	 * @param montantInitial IN montant initialement déposer pour la création du compte
	 * @param idNumClient IN id du compte (clé primaire)
	 * @throws DataAccessException
	 * @throws DatabaseConnexionException
	 * @throws ManagementRuleViolation
	 */
	public void insertCompteCourant(int debitAutorise, double montantInitial, int idNumClient)
		...
		try {
			...
			// Paramètres in
			call.setInt(1, debitAutorise);
			// 1 -> valeur du premier paramètre, cf. déf procédure
			call.setDouble(2, montantInitial);
